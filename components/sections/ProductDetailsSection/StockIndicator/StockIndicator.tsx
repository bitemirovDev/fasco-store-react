...
import { calcStockIndicatorLineWidth } from '@/utils/calc-stock-indicator-line-width';
  ...
  return (
    <div className={styles['stock']}>
      ...
      <div className={styles['stock-status']}>
        <div className={styles['stock-status-level']} style={{ width: `${stockIndicatorWidth}%` }}></div>
      </div>
    </div>
  );
}
